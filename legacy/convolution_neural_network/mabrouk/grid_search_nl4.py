...
signal = np.loadtxt(fname = "roessler_signal")
...
sample_number = 500
signal_scaling_origin = 0.6
network_scaling_origin = 0.4
signal_scaling_range = 0.3
network_scaling_range = 0.3
...
energy_landscape = [Parallel(n_jobs=5)\
...
np.savetxt('roess_old_landscape', energy_landscape)
